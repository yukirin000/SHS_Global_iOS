...
@interface YSAlertView ()<UIAlertViewDelegate>
       ...
       otherButtonTitles:(NSString *)otherButtonTitles, ...
{
    ...
    YSAlertView *alertView = [[self alloc] initWithTitle:title
                                                 message:message
...
+ (id)initWithTitle:(NSString *)title
  ...
  otherButtonTitles:(NSString *)otherButtonTitles, ... {
    ...
    YSAlertView *alertView = [[YSAlertView alloc] initWithTitle:title message:message completionBlock:block cancelButtonTitle:cancelButtonTitle otherButtonTitles:nil];
    if (otherButtonTitles != nil) {
        id eachObject;
        va_list argumentList;
        if (otherButtonTitles) {
